...
def relink(old_key: str, new_key: str) -> int:
    """Copia memoria + transcripts de la clave vieja a la nueva (sin pisar lo más nuevo)
    y archiva la clave vieja. Devuelve cuántos archivos de memoria copió."""
